    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="bg-green-50 p-2 rounded-lg">
          ...
          <p className="text-sm font-mono font-bold text-green-700">{algorithm.timeComplexity.best}</p>
        </div>
        <div className="bg-yellow-50 p-2 rounded-lg">
          <p className="text-xs text-yellow-600 font-medium mb-1">Average</p>
          <p className="text-sm font-mono font-bold text-yellow-700">{algorithm.timeComplexity.average}</p>
        </div>
        <div className="bg-red-50 p-2 rounded-lg">
          <p className="text-xs text-red-600 font-medium mb-1">Worst</p>
          <p className="text-sm font-mono font-bold text-red-700">{algorithm.timeComplexity.worst}</p>
        </div>
      </div>
    </div>
  );
